...
document.getElementById('refreshTopButton')!.addEventListener(
    'click', refreshFirstSlot);
document.getElementById('refreshBottomButton')!.addEventListener(
    'click', refreshSecondSlot);
document.getElementById('refreshAllButton')!.addEventListener(
    'click', refreshAllSlots);
document.getElementById('clearAllButton')!.addEventListener(
    'click', clearAllSlots);
// [END request_ads]
